...
export function OrdersDatePicker({ value, label, onChange }: OrdersDatePickerProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        aria-label={`Escolher data dos pedidos. Data selecionada: ${label}`}
      ...
      {isOpen && (
        <div
          role="dialog"
          aria-label="Calendário de pedidos"
