-- Storefront order creation must reject archived restaurants inside the transaction itself.
-- This closes the race between the public API restaurant lookup and the transactional insert.
